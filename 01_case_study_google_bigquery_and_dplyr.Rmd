...
Now I can use [dplyr verbs](https://dplyr.tidyverse.org/) to explore the dataset.  
...
[DBplot](https://db.rstudio.com/dbplot/) leverages dployr to process the calculationsof a plot inside a database.
...
Good and healthy trees offset from the curb.
